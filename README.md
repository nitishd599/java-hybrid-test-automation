...
┌───────────────┐   ┌──────────────────┐   ┌──────────────────┐
│ core.actions  │   │  core.driver     │   │   core.api       │
│ ElementActions│   │ DriverManager    │   │ RequestBuilder   │
│ MobileActions │   │ DriverFactories  │   │ ApiUtils         │
└───────┬───────┘   └────────┬─────────┘   └────────┬─────────┘
        │                    │                      │
        ▼                    ▼                      ▼
...
✔ No business logic in step definitions<br/>
✔ Thread-safe execution using ThreadLocal<br/>
